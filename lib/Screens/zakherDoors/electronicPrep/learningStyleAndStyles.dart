      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            MyDetailsList(
              LocaleKeys
                      .ElectronicPreparation_LearnigStyleAndStylesScreen_Experience
                  .tr(),
            ),
            MyDetailsList(
              LocaleKeys
                      .ElectronicPreparation_LearnigStyleAndStylesScreen_Biology
                  .tr(),
            ),
            MyDetailsList(
              LocaleKeys
                      .ElectronicPreparation_LearnigStyleAndStylesScreen_Ifollow
                  .tr(),
            ),
            MyDetailsList(
              LocaleKeys
                      .ElectronicPreparation_LearnigStyleAndStylesScreen_Phenomena
                  .tr(),
            ),
            MyDetailsList(
              LocaleKeys
                      .ElectronicPreparation_LearnigStyleAndStylesScreen_Natural
                  .tr(),
            ),
          ],
        ),
