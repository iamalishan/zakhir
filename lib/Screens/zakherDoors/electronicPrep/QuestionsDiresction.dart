...
class QuestionsDirestions extends StatefulWidget {
  const QuestionsDirestions({Key? key}) : super(key: key);

  @override
  _QuestionsDirestionsState createState() => _QuestionsDirestionsState();
}

class _QuestionsDirestionsState extends State<QuestionsDirestions> {
  @override
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            MyDetailsList(
              LocaleKeys
                      .ElectronicPreparation_QuestionsDiresctionsScreen_Generalanswer
                  .tr(),
            ),
            MyDivider(),
            MyDetailsList(
